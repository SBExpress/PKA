...
export default function BulkImportContacts({ org }) {
  ...
  function downloadErrorCSV() {
    ...
    a.href = url
    a.download = `contact-import-errors-${Date.now()}.csv`
    a.click()
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <code className="text-xs bg-blue-100 p-3 block rounded text-blue-900 mb-2 overflow-x-auto">
          name,email,phone,title,company_name
          <br />
          John Doe,john@abc.com,555-5678,Project Manager,ABC Corp
        </code>
        <p className="text-sm text-blue-800 mb-2">
          <strong>Required:</strong> name, company_name | <strong>Optional:</strong>{' '}
          email, phone, title
        </p>
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> company_name must match an existing customer
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="name,email,phone,title,company_name&#10;John Doe,john@abc.com,555-5678,PM,ABC Corp"
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-green-800">
                  {result.successful} contact{result.successful !== 1 ? 's' : ''}{' '}
                  imported
                </p>
              </div>
            </div>
